...
readonly WORKER_DATA_DISK_PATTERN="${CLUSTER_PREFIX}-ww-new-%d-data"

# By default all hosts will be 4 core standard instances
# in the zone us-central1-a, running debian-7
readonly MASTER_NODE_MACHINE_TYPE=n1-standard-1
readonly MASTER_NODE_ZONE=us-central1-b
readonly MASTER_NODE_IMAGE=debian-7
readonly MASTER_NODE_DISK_SIZE=100GB
readonly MASTER_NODE_SCOPE=

readonly WORKER_NODE_MACHINE_TYPE=n1-standard-1
readonly WORKER_NODE_ZONE=us-central1-b
readonly WORKER_NODE_IMAGE=debian-7
readonly WORKER_NODE_DISK_SIZE=100GB
readonly WORKER_NODE_SCOPE=

# Specify the number of each node type
readonly MASTER_NODE_COUNT=1
readonly WORKER_NODE_COUNT=1
